    ...
    <section class="invoice-preview-wrapper">
        <div class="row invoice-preview">
                            ...
                            <div class="mt-md-0 mt-2">
                                ...
                                <div class="invoice-date-wrapper">
                                    ...
                                    <p class="invoice-date">
                                        {{ \Carbon\Carbon::parse($responseBody['created_at'])->format('Y-m-d') }}</p>
                                </div>
                                <div class="invoice-date-wrapper">
                                    <p class="invoice-date-title">Due Date:</p>
                                    <p class="invoice-date">
                                        {{ \Carbon\Carbon::parse($responseBody['due_date'])->format('Y-m-d') }}</p>
                                </div>
                            </div>
                        </div>
                        <!-- Header ends -->
                                ...
                                <table>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><span class="font-weight-bold">{{ $responseBody['total'] }}</span></td>
                                        </tr>
                                        <tr>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                @foreach ($responseBody['invoice_details'] as $item)
                                    <tr>
                                        <td class="py-1">
                                            <p class="card-text text-nowrap">{{ $item['detail'] }}</p>
                                        </td>
                                        <td class="py-1">
                                            <p class="card-text text-nowrap">OMR {{ $item['amount'] }}</p>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
            ...
            <div class="col-xl-3 col-md-4 col-12 invoice-actions mt-md-0 mt-2">
                <div class="card">
                    <div class="card-body">
                        <a class="btn btn-outline-secondary btn-block mb-75" href="{{ url('invoice/'.$responseBody['id'].'/print') }}"
                            target="_blank">
                            Print
                        </a>
                    </div>
