                    ...
                    <div class="table-responsive">
                        <table class="table">
                            <tbody>
                                ...
                                <tr>
                                    <th>Landlord</th>
                                    <td>{!! $responseBody->landlord ? '<a href="/landlord/landlord/'. $responseBody->landlord->id .'">'. $responseBody->landlord->first_name . " " . $responseBody->landlord->last_name .'</a>'  : 'HIG' !!}</td>
                                </tr>
                                <tr>
                                    <th>Images</th>
                                    <td>
