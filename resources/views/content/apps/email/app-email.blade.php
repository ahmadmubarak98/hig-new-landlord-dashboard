    ...
    <ul class="email-media-list">
        ...
        <div class="media-body">
          ...
          <div class="mail-message">
            <p class="text-truncate mb-0">
              Hey Admin, bah kivu decrete epanorthotic unnotched Argyroneta nonius veratrine preimaginary saunders
      ...
      <li class="media">
        ...
        <div class="media-body">
          ...
          <div class="mail-message">
            <p class="mb-0 text-truncate">
              Hey Admin, Parthenopean logeion chipwood tonsilitic cockleshell substance Stilbum dismayed tape Alderamin
      ...
      <li class="media mail-read">
        ...
        <div class="media-body">
          ...
          <div class="mail-message">
            <p class="mb-0 text-truncate">
              Hi Admin, wartproof ketoheptose incomplicate hyomental organal supermaterial monogene sophister nizamate
      ...
      <li class="media mail-read">
        ...
        <div class="media-body">
          ...
          <div class="mail-message">
            <p class="mb-0 text-truncate">
              Hi Admin,Biscuit lemon drops marshmallow. Cotton candy marshmallow bear claw. Dragée tiramisu cookie cotton
      ...
      <li class="media">
        ...
        <div class="media-body">
          ...
          <div class="mail-message">
            <p class="mb-0 text-truncate">
              Hello Admin,Chocolate bar chupa chups sweet roll chocolate muffin macaroon liquorice tart. Carrot cake
      ...
      <li class="media mail-read">
        ...
        <div class="media-body">
          ...
          <div class="mail-message">
            <p class="mb-0 text-truncate">
              Hi Admin,Biscuit lemon drops marshmallow. Marzipan carrot cake soufflé. Toffee tiramisu pudding cotton
