        ...
        <form>
          <div class="row">
            <div class="form-group col-md-6">
              ...
              <input type="text" name="username" id="username" class="form-control" placeholder="Admindoe" />
            </div>
            <div class="form-group col-md-6">
        ...
        <form>
          <div class="row">
            <div class="form-group col-md-6">
              ...
              <input type="text" name="first-name" id="first-name" class="form-control" placeholder="Admin" />
            </div>
            <div class="form-group col-md-6">
      ...
      <div id="account-details-vertical" class="content">
        ...
        <div class="row">
          <div class="form-group col-md-6">
            ...
            <input type="text" id="vertical-username" class="form-control" placeholder="Admindoe" />
          </div>
          <div class="form-group col-md-6">
      ...
      <div id="personal-info-vertical" class="content">
        ...
        <div class="row">
          <div class="form-group col-md-6">
            ...
            <input type="text" id="vertical-first-name" class="form-control" placeholder="Admin" />
          </div>
          <div class="form-group col-md-6">
      ...
      <div id="account-details-modern" class="content">
        ...
        <div class="row">
          <div class="form-group col-md-6">
            ...
            <input type="text" id="modern-username" class="form-control" placeholder="Admindoe" />
          </div>
          <div class="form-group col-md-6">
      ...
      <div id="personal-info-modern" class="content">
        ...
        <div class="row">
          <div class="form-group col-md-6">
            ...
            <input type="text" id="modern-first-name" class="form-control" placeholder="Admin" />
          </div>
          <div class="form-group col-md-6">
      ...
      <div id="account-details-vertical-modern" class="content">
        ...
        <div class="row">
          <div class="form-group col-md-6">
            ...
            <input type="text" id="vertical-modern-username" class="form-control" placeholder="Admindoe" />
          </div>
          <div class="form-group col-md-6">
      ...
      <div id="personal-info-vertical-modern" class="content">
        ...
        <div class="row">
          <div class="form-group col-md-6">
            ...
            <input type="text" id="vertical-modern-first-name" class="form-control" placeholder="Admin" />
          </div>
          <div class="form-group col-md-6">
