...
<div class="main-menu menu-fixed {{ $configData['theme'] === 'dark' ? 'menu-dark' : 'menu-light' }} menu-accordion menu-shadow"
    ...
    <div class="navbar-header "  style="background-color:#161c30;">
        <ul class="nav navbar-nav flex-row" >
            <li class="nav-item mr-auto">
                <div style="width:100%;height:100%;">
                    <img src="{{ url('images/logo/logo.png') }}" style="object-fit:contain;height:95%;width:100%;" />
                </div>
            </li>
                    ...
                    @else
                        ...
                        <li
                            ...
                            <a href="{{ isset($menu->url) ? url($menu->url) : 'javascript:void(0)' }}"
                                ...
                                @if (isset($menu->badge))
                                    <?php $badgeClasses = 'badge badge-pill badge-light-primary ml-auto
                                    mr-1'; ?>
                                    <span
