      ...
      <div class="card-body">
        ...
        <form class="auth-reset-password-form mt-2" method="POST" action="{{ route('password.update') }}">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control @error('email') is-invalid @enderror" id="email" name="email" placeholder="name@example.com" aria-describedby="email" tabindex="1" autofocus value="{{ $email ?? old('email') }}" />
              @error('email')
